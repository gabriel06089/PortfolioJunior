    ...
    <>
      <AngryGrid onMouseMove={handleMouseMove}>
        <DivGrid0>
          ...
          <p>
            Estou em busca de oportunidades desafiadoras em empresas inovadoras,
            onde posso contribuir ativamente com meu conhecimento e habilidades
            técnicas, enquanto continuo aprendendo e evoluindo como
            desenvolvedor. Estou aberto a projetos ambiciosos, em um ambiente
            dinâmico e estimulante, enfrentando desafios complexos e encontrando
            soluções criativas.
          </p>
          <p>
            Se você procura por um desenvolvedor dedicado, curioso e apaixonado
            por tecnologia, estou pronto para fazer parte da sua equipe e
            contribuir para o sucesso da sua empresa. Vamos construir algo
            incrível juntos!
          </p>
          <WorkButton>
